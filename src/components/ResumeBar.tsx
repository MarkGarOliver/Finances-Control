    ...
    return (
        <div className='flex justify-around bg-slate-800 p-11 mb-10 border border-slate-800 rounded-xl shadow'>
            ...
            <div className='mt-auto mb-auto' id='dropdown'>
                ...
                <input onChange={onChangeData} className='rounded-lg w-64 p-2 font-semibold text-black' type="month" id="bdaymonth" name="bdaymonth" /> 

                <button onClick={onClickBuscar} className=' ml-2 bg-slate-700 w-32 h-11 mt-9 rounded-lg hover:bg-slate-600'>Buscar</button>
