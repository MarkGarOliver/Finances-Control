                    ...
                    <ul className="space-y-2">
                        ...
                        <li>
                            <a href="#" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <span className="flex-1 ml-3 whitespace-nowrap">Entrar</span>
                            </a>
                        </li>
                    </ul>
                    <div id="dropdown-cta" className="p-4 mt-80 bg-blue-50 rounded-lg dark:bg-blue-900" role="alert">
                        ...
                        <p className="mb-3 text-sm text-blue-900 dark:text-blue-400">
                            Esta é uma versão beta. O sistema ainda está em aprimoramento e pode haver pequenos bugs e erros. Caso ocorra algum problema, por favor reporte para que nossa equipe possa solucionar.
                        </p>
                        <a className="text-sm text-blue-900 underline hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300" href="#">Reportar via Email</a>
